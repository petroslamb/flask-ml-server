...
class EnvironmentValidator:
    ...
    def __init__(self):
        ...
        self.models_base_path = src.services.app_config.get('MODELS_BASE_DIR')
        self.model_names = src.services.app_config.get('MODEL_NAMES')
        self.model_file_names = src.services.app_config.get('MODEL_FILES')
